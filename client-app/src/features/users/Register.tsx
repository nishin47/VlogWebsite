...
import { Button, Grid, Header, Label, Segment ,Image} from 'semantic-ui-react';
            ...
            {({ handleSubmit, isSubmitting, errors, isValid, dirty }) => (
                ...
                <Segment className='Signinform'>
                    <Grid columns={2} padded>
                        ...
                        <Grid.Column width={6} textAlign='center'  style={{ maxWidth: 400, background: 'white',marginTop: '5%',maxHeight: 550 }}  >
